//===--- ExecSQLFreeToFunctionCall.h - clang-tidy --------------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLFREETOFUNCTIONCALL_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLFREETOFUNCTIONCALL_H
...
namespace clang 
{
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      class ExecSQLFreeToFunctionCall : public ClangTidyCheck 
      {
      public:
	...
	// Constructor
	ExecSQLFreeToFunctionCall(StringRef, ClangTidyContext *);
	...
	public:
	  ...
	  explicit CopyRequestMatcher(ExecSQLFreeToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindAssignMatcher(ExecSQLFreeToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindReqFmtMatcher(ExecSQLFreeToFunctionCall *parent)
	    : m_parent(parent)
	  {}
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLFREETOFUNCTIONCALL_H
