  ...
  namespace tidy
  {
    ...
    namespace pagesjaunes
    {
      ...
      namespace test
      {
        ...
        class FetchTmplRepeatMembersTest : public ::testing::Test
        {
        public:
          FetchTmplRepeatMembersTest();
          virtual ~FetchTmplRepeatMembersTest();
          ...
          void PrintTo(const FetchTmplRepeatMembersTest&, ::std::ostream*);
