//===------- lob_create_regex_test.cpp - clang-tidy ----------------------------===//
//
...
#include "lob_create_regex_test.h"
  ...
  namespace tidy
  {
    ...
    namespace pagesjaunes
    {
      ...
      namespace test
      {
        ...
        LobCreateRegexTest::LobCreateRegexTest()
          : lob_create_re_m(PAGESJAUNES_REGEX_EXEC_SQL_LOB_CREATE_REQ_RE)
        {
        }
        ...
        void
        LobCreateRegexTest::SetUp(void)
        {
        }
        
        void
        LobCreateRegexTest::TearDown(void)
        {
        }
        
        void
        LobCreateRegexTest::PrintTo(const LobCreateRegexTest& lob_create_regex_test, ::std::ostream* os)
        {
        }

        TEST_F(LobCreateRegexTest, RegexMatchingIndicators)
        {
#define REQ0                                                            \
          "EXEC SQL LOB_CREATE :emp_cv;" 
          
          llvm::StringRef req0(REQ0);
          SmallVector<StringRef, 8> matches0;
          bool retbool0 = get_lob_create_re().match(req0, &matches0);
          EXPECT_TRUE(retbool0);
          int retsize0 = matches0.size();
          EXPECT_EQ(retsize0, 4);
          if (retbool0 && retsize0 == 4)
            {
              EXPECT_STREQ(matches0[0].str().c_str(), "EXEC SQL LOB_CREATE :emp_cv;");
              EXPECT_STREQ(matches0[1].str().c_str(), "LOB_CREATE");
...
#define REQ1                                                            \
          ...
          bool retbool1 = get_lob_create_re().match(req1, &matches1);
          ...
          if (retbool1 && retsize1 == 4)
            {
              ...
              EXPECT_STREQ(matches1[1].str().c_str(), "LOB_CREATE");
              EXPECT_STREQ(matches1[2].str().c_str(), ":emp_cv");
              EXPECT_STREQ(matches1[3].str().c_str(), "emp_cv");
            }
        }

        TEST_F(LobCreateRegexTest, RegexMatchingWeirdSyntax)
        {
#define REQWEIRD_0                                                            \
          "EXEC SQL \n  LOB_CREATE : emp_cv ;"
          ...
          SmallVector<StringRef, 8> matches0;
          bool retbool0 = get_lob_create_re().match(reqweird0, &matches0);
          EXPECT_TRUE(retbool0);
          int retsize0 = matches0.size();
          EXPECT_EQ(retsize0, 4);
          if (retbool0 && retsize0 == 4)
...
#define REQWEIRD_1                                                            \
          ...
          SmallVector<StringRef, 8> matches1;
          bool retbool1 = get_lob_create_re().match(reqweird1, &matches1);
          EXPECT_TRUE(retbool1);
          int retsize1 = matches1.size();
          EXPECT_EQ(retsize1, 4);
          if (retbool1 && retsize1 == 4)
...
#define REQWEIRD_2                                                            \
          ...
          bool retbool2 = get_lob_create_re().match(reqweird2, &matches2);
...
#define REQWEIRD_3                                                            \
          ...
          bool retbool3 = get_lob_create_re().match(reqweird3, &matches3);
          ...
          if (retbool3 && retsize3 == 4)
            {
              ...
              EXPECT_STREQ(matches3[1].str().c_str(), "Lob_Create");
