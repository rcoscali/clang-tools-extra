//===--- ExecSQLForToFunctionCall.h - clang-tidy --------------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLFORTOFUNCTIONCALL_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLFORTOFUNCTIONCALL_H
...
namespace clang 
{
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      class ExecSQLForToFunctionCall : public ClangTidyCheck 
      {
      public:
	...
	// Constructor
	ExecSQLForToFunctionCall(StringRef, ClangTidyContext *);
	...
	public:
	  ...
	  explicit CopyRequestMatcher(ExecSQLForToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	private:
	  // Parent ExecSQLForToFunctionCall instance
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindAssignMatcher(ExecSQLForToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindReqFmtMatcher(ExecSQLForToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	enum ExecSQLForToFunctionCallErrorKind
	  {
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLFORTOFUNCTIONCALL_H
