//===--- ExecSQLLOBCloseToFunctionCall.cpp - clang-tidy ----------------------------===//
//
  ...
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      namespace {
        ...
        public:
          explicit GetStringLiteralsDefines(ExecSQLLOBCloseToFunctionCall *parent,
                                            ExecSQLLOBCloseToFunctionCall::source_range_set_t *srset)
            : m_parent(parent),
                ...
                if (have_literal)
                  {
                    ...
                    ExecSQLLOBCloseToFunctionCall::SourceRangeForStringLiterals *ent
                      = new ExecSQLLOBCloseToFunctionCall::SourceRangeForStringLiterals(range, sr, macroName);
        ...
        private:
          ...
          ExecSQLLOBCloseToFunctionCall::source_range_set_t *m_macrosStringLiteralsPtr;
        };
      } // namespace
      
      /**
       * ExecSQLLOBCloseToFunctionCall constructor
       *
       * @brief Constructor for the ExecSQLLOBCloseToFunctionCall rewriting check
       *
       ...
       */
      ExecSQLLOBCloseToFunctionCall::ExecSQLLOBCloseToFunctionCall(StringRef Name,
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::onStartOfTranslationUnit()
      {
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::onEndOfTranslationUnit()
      {
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::storeOptions(ClangTidyOptions::OptionMap &Opts)
      {
       ...
       */
      void 
      ExecSQLLOBCloseToFunctionCall::registerMatchers(MatchFinder *Finder) 
      {
      ...
      /**
       * ExecSQLLOBCloseToFunctionCall::registerPPCallbacks
       *
       ...
       */
      void ExecSQLLOBCloseToFunctionCall::registerPPCallbacks(CompilerInstance &compiler) {
        compiler
          .getPreprocessor()
      ...
      /*
       * ExecSQLLOBCloseToFunctionCall::emitDiagAndFix
       *
       ...
       */
      std::string
      ExecSQLLOBCloseToFunctionCall::emitDiagAndFix(const SourceLocation& loc_start,
      ...
      /**
       * ExecSQLLOBCloseToFunctionCall::processTemplate
       *
       ...
       */
      bool
      ExecSQLLOBCloseToFunctionCall::processTemplate(const std::string& tmpl,
      ...
      /**
       * ExecSQLLOBCloseToFunctionCall::doRequestSourceGeneration
       *
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::doRequestSourceGeneration(DiagnosticsEngine& diag_engine,
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_EXISTS,
		    &fileName);
        // Process template for creating source file
        else if (!processTemplate(tmpl, fileName, values_map))
          emitError(diag_engine,
                    dummy,
                    ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_GENERATION,
                    &fileName);
      }
      
      /**
       * ExecSQLLOBCloseToFunctionCall::doRequestHeaderGeneration
       *
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::doRequestHeaderGeneration(DiagnosticsEngine& diag_engine,
                                                                const std::string& tmpl,
                                                                string2_map& values_map)
      { 
        SourceLocation dummy;
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_EXISTS,
		    &fileName);
        // Process template for creating header file
        else if (!processTemplate(tmpl, fileName, values_map))
          emitError(diag_engine,
                    dummy,
                    ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_GENERATION,
                    &fileName);
      }
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::emitError(DiagnosticsEngine &diag_engine,
                                                const SourceLocation& err_loc,
                                                enum ExecSQLLOBCloseToFunctionCallErrorKind kind,
	...
	unsigned diag_id;
	    ...
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_NO_ERROR:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_ACCESS_CHAR_DATA:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_CANT_FIND_COMMENT_START:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_COMMENT_DONT_MATCH:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Warning,
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_GENERATION:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_GENERATION:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_EXISTS:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_EXISTS:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
       ...
       */
      void
      ExecSQLLOBCloseToFunctionCall::check(const MatchFinder::MatchResult &result) 
      {
        ...
        if (lineNum > 0 && !errOccured)
          {
            ...
            Regex lobCloseReqRe(PAGESJAUNES_REGEX_EXEC_SQL_LOB_CLOSE_REQ_RE);
             ...
             * =============================================================================
             */
            if (lobCloseReqRe.match(comment, &matches))
              {
                std::string reqAllocName = matches[3];
                std::string requestExecSql = "LOB CLOSE :";
                requestExecSql.append(reqAllocName);
                
                // Append first match (action) to function name
                function_name.append("lobClose");
              ...
              emitError(diagEngine,
                        comment_loc_start,
                        ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_COMMENT_DONT_MATCH);
          }
        else
          {
            if (errOccured)
              ...
              emitError(diagEngine,
                        loc_start,
                        ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_ACCESS_CHAR_DATA);

            else
              // We didn't found the comment start ???
              emitError(diagEngine,
                        comment_loc_end,
                        ExecSQLLOBCloseToFunctionCall::EXEC_SQL_2_FUNC_ERROR_CANT_FIND_COMMENT_START);
          }
      }
    } // namespace pagesjaunes
  } // namespace tidy
