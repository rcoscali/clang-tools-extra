//===--- ExecSQLAllocateToFunctionCall.h - clang-tidy --------------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLALLOCATETOFUNCTIONCALL_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLALLOCATETOFUNCTIONCALL_H
...
namespace clang 
{
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      class ExecSQLAllocateToFunctionCall : public ClangTidyCheck
      {
      public:
	...
	// Constructor
	ExecSQLAllocateToFunctionCall(StringRef, ClangTidyContext *);
	...
	public:
	  ...
	  explicit CopyRequestMatcher(ExecSQLAllocateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	private:
	  // Parent ExecSQLAllocateToFunctionCall instance
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindAssignMatcher(ExecSQLAllocateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindReqFmtMatcher(ExecSQLAllocateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	enum ExecSQLAllocateToFunctionCallErrorKind
	  {
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit VarDeclMatcher(ExecSQLAllocateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLALLOCATETOFUNCTIONCALL_H
