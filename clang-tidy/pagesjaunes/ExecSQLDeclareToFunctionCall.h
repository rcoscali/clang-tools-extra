//===--- ExecSQLDeclareToFunctionCall.h - clang-tidy --------------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLDECLARETOFUNCTIONCALL_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLDECLARETOFUNCTIONCALL_H
...
namespace clang 
{
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      class ExecSQLDeclareToFunctionCall : public ClangTidyCheck 
      {
      public:

	enum ExecSQLDeclareToFunctionCallErrorKind
	  {
	...
	// Constructor
	ExecSQLDeclareToFunctionCall(StringRef, ClangTidyContext *);
	...
	public:
	  ...
	  explicit VarDeclMatcher(ExecSQLDeclareToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	private:
	  // Parent ExecSQLDeclareToFunctionCall instance
	...
	// Request header template (default: "./pagesjaunes_declare.h.tmpl")
	const std::string generation_header_template;
	// Request source template (default: "./pagesjaunes_declare.pc.tmpl")
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLDECLARETOFUNCTIONCALL_H
