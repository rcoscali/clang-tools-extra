//===--- ExecSQLLOBCreateToFunctionCall.h - clang-tidy --------------------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLLOBCREATETOFUNCTIONCALL_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLLOBCREATETOFUNCTIONCALL_H
...
namespace clang 
{
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      class ExecSQLLOBCreateToFunctionCall : public ClangTidyCheck 
      {
      public:
	...
	// Constructor
	ExecSQLLOBCreateToFunctionCall(StringRef, ClangTidyContext *);
	...
	public:
	  ...
	  explicit CopyRequestMatcher(ExecSQLLOBCreateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindAssignMatcher(ExecSQLLOBCreateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
	...
	public:
	  /// Explicit constructor taking the parent instance as param
	  explicit FindReqFmtMatcher(ExecSQLLOBCreateToFunctionCall *parent)
	    : m_parent(parent)
	  {}
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_PAGESJAUNES_EXECSQLLOBCREATETOFUNCTIONCALL_H
