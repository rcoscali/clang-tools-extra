  ...
  namespace tidy 
  {
    namespace pagesjaunes
    {
	  ...
	  generate_req_allow_overwrite(Options.get("Generate-requests-allow-overwrite",
          ...
          generation_do_keep_commented_out_exec_sql(Options.get("Generation-keep-commented-out-exec-sql-in-PC",
                                                                0U))
      {
        llvm::outs() << "ExecSQLLOBCreateToFunctionCall::ExecSQLLOBCreateToFunctionCall(StringRef Name, ClangTidyContext *Context):\n";
       ...
       */
      void
      ExecSQLLOBCreateToFunctionCall::onStartOfTranslationUnit()
      {
       ...
       */
      void
      ExecSQLLOBCreateToFunctionCall::onEndOfTranslationUnit()
      {
      ...
      {
        llvm::outs() << "ExecSQLLOBCreateToFunctionCall::storeOptions(ClangTidyOptions::OptionMap &Opts):\n";
        llvm::outs() << "    generate_req_headers = " << (generate_req_headers?"True":"False") << "\n";
        llvm::outs() << "    generate_req_sources = " << (generate_req_sources?"True":"False") << "\n";
        llvm::outs() << "    generate_req_allow_overwrite = " << (generate_req_allow_overwrite?"True":"False") << "\n";
        llvm::outs() << "    generation_directory = '" << generation_directory << "'\n";
	...
	fileName.append(GENERATION_SOURCE_FILENAME_EXTENSION);
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_CREATE_DIR,
		    &fileName);          
        else if (!generate_req_allow_overwrite &&
                 (stat (fileName.c_str(), &buffer) == 0))
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_EXISTS,
		    &fileName);
	...
	fileName.append(GENERATION_HEADER_FILENAME_EXTENSION);
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_CREATE_DIR,
		    &fileName);          
        else if (!generate_req_allow_overwrite &&
                 (stat (fileName.c_str(), &buffer) == 0))
	  emitError(diag_engine,
	...
	// Process template for creating header file
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_EXISTS,
		    &fileName);
      }
	...
	unsigned diag_id;
	    ...
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_EXISTS:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Warning,
          ...
          case ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_EXISTS:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Warning,
          ...
          case ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_CREATE_DIR:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_CREATE_DIR:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Error,
                              "Couldn't create directory for '%0'!");
            diag_engine.Report(diag_id).AddString(msg);
          ...
          case ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_UNSUPPORTED_STRING_CHARSET:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBCreateToFunctionCall::EXEC_SQL_2_FUNC_ERROR_INVALID_GROUPS_FILE:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Error,
      ...
      /**
       * ExecSQLLOBCreateToFunctionCall::findMacroStringLiteralDefAtLine
       *
       ...
       */
      bool
      ExecSQLLOBCreateToFunctionCall::findMacroStringLiteralDefAtLine(SourceManager &src_mgr,
								    unsigned ln,
	...
	return ret;
      ...
      /*
       * ExecSQLLOBCreateToFunctionCall::createParamsDef
       *
       ...
       */
      std::string
      ExecSQLLOBCreateToFunctionCall::createParamsDef(const std::string& type,
      ...
      /*
       * ExecSQLLOBCreateToFunctionCall::createParamsDeclareSection
       *
       ...
       */
      std::string
      ExecSQLLOBCreateToFunctionCall::createParamsDeclareSection(const std::string& type,
                                                            const std::string& elemtype,
                                                            const std::string& size,
                                                            const std::string& name,
      ...
      /*
       * ExecSQLLOBCreateToFunctionCall::createParamsDecl
       *
       ...
       */
      std::string
      ExecSQLLOBCreateToFunctionCall::createParamsDecl(const std::string& type,
                                                  const std::string& elemtype,
                                                  const std::string& size)
      {
      ...
      /*
       * ExecSQLLOBCreateToFunctionCall::createParamsCall
       *
       ...
       */
      std::string
      ExecSQLLOBCreateToFunctionCall::createParamsCall(const std::string& name)
      {
        return clang::tidy::pagesjaunes::createParamsCall(name);
      }
      
      /*
       * ExecSQLLOBCreateToFunctionCall::createHostVarList
       *
       ...
       */
      std::string
      ExecSQLLOBCreateToFunctionCall::createHostVarList(const std::string& name, bool isIndicator = false)
      {
        return clang::tidy::pagesjaunes::createHostVarList(name, isIndicator);
      }
      
      /**
       * ExecSQLLOBCreateToFunctionCall::findSymbolInFunction
       *
       ...
       */
      const VarDecl *
      ExecSQLLOBCreateToFunctionCall::findSymbolInFunction(std::string& varName, const FunctionDecl *func)
      {
      ...
      /**
       * ExecSQLLOBCreateToFunctionCall::findDeclInFunction
       *
       ...
       */
      string2_map
      ExecSQLLOBCreateToFunctionCall::findDeclInFunction(const FunctionDecl *func, const std::string& symName)
      {
        return clang::tidy::pagesjaunes::findDeclInFunction(func, symName);
      }

      /**
       * ExecSQLLOBCreateToFunctionCall::findCXXRecordMemberInTranslationUnit
       *
       ...
       */
      string2_map
      ExecSQLLOBCreateToFunctionCall::findCXXRecordMemberInTranslationUnit(const TranslationUnitDecl *transUnit,
      ...
      /**
       * ExecSQLLOBCreateToFunctionCall::decodeHostVars
       *
       ...
       */
      map_host_vars
      ExecSQLLOBCreateToFunctionCall::decodeHostVars(const std::string &hostVarsList)
      {
      ...
      {
        outs() << "void ExecSQLLOBCreateToFunctionCall::check(const MatchFinder::MatchResult &result): ENTRY!\n";
	...
	if (lineNum > 0 && !errOccured)
	  {
	    ...
	    outs() << "comment found for compound statement at line #" << startLineNum << ": '" << comment << "'\n";
            ...
            Regex lobCreateReqRe(PAGESJAUNES_REGEX_EXEC_SQL_LOB_CREATE_REQ_RE);
	    ...
	    std::string requestArgs;
            ...
            if (lobCreateReqRe.match(comment, &matches))
              {
                std::string reqAllocName = matches[PAGESJAUNES_REGEX_EXEC_SQL_LOB_CREATE_REQ_RE_HOSTVARS];
                std::string requestExecSql = matches[PAGESJAUNES_REGEX_EXEC_SQL_LOB_CREATE_REQ_RE_LOB];
                ...
                // We have one host variable only for LOB CREATE TEMPORARY but it could be pointer/member
                if (!hvm["deref"].empty())
                  {
                ...
                requestExecSql.append(matches[PAGESJAUNES_REGEX_EXEC_SQL_LOB_CREATE_REQ_RE_CREATE]);
                requestExecSql.append(" ");
                requestExecSql.append(matches[PAGESJAUNES_REGEX_EXEC_SQL_LOB_CREATE_REQ_RE_TEMPORARY]);
                requestExecSql.append(" :");
                requestExecSql.append(hostVarName);
                
                // Append first match (action) to function name
                requestFunctionName.assign("lobCreateTemporary");
