//===--- ExecSQLLOBOpenToFunctionCall.cpp - clang-tidy ----------------------------===//
//
  ...
  namespace tidy 
  {
    namespace pagesjaunes
    {
      ...
      namespace {
        ...
        public:
          explicit GetStringLiteralsDefines(ExecSQLLOBOpenToFunctionCall *parent,
                                            ExecSQLLOBOpenToFunctionCall::source_range_set_t *srset)
            : m_parent(parent),
                ...
                if (have_literal)
                  {
                    ...
                    ExecSQLLOBOpenToFunctionCall::SourceRangeForStringLiterals *ent
                      = new ExecSQLLOBOpenToFunctionCall::SourceRangeForStringLiterals(range, sr, macroName);
        ...
        private:
          ...
          ExecSQLLOBOpenToFunctionCall::source_range_set_t *m_macrosStringLiteralsPtr;
        };
      } // namespace
      
      /**
       * ExecSQLLOBOpenToFunctionCall constructor
       *
       * @brief Constructor for the ExecSQLLOBOpenToFunctionCall rewriting check
       *
       ...
       */
      ExecSQLLOBOpenToFunctionCall::ExecSQLLOBOpenToFunctionCall(StringRef Name,
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::onStartOfTranslationUnit()
      {
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::onEndOfTranslationUnit()
      {
     ...
     /**
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::storeOptions(ClangTidyOptions::OptionMap &Opts)
      {
       ...
       */
      void 
      ExecSQLLOBOpenToFunctionCall::registerMatchers(MatchFinder *Finder) 
      {
      ...
      /**
       * ExecSQLLOBOpenToFunctionCall::registerPPCallbacks
       *
       ...
       */
      void ExecSQLLOBOpenToFunctionCall::registerPPCallbacks(CompilerInstance &compiler) {
        compiler
          .getPreprocessor()
      ...
      /*
       * ExecSQLLOBOpenToFunctionCall::emitDiagAndFix
       *
       ...
       */
      std::string
      ExecSQLLOBOpenToFunctionCall::emitDiagAndFix(const SourceLocation& loc_start,
      ...
      /**
       * ExecSQLLOBOpenToFunctionCall::processTemplate
       *
       ...
       */
      bool
      ExecSQLLOBOpenToFunctionCall::processTemplate(const std::string& tmpl,
      ...
      /**
       * ExecSQLLOBOpenToFunctionCall::doRequestSourceGeneration
       *
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::doRequestSourceGeneration(DiagnosticsEngine& diag_engine,
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_EXISTS,
		    &fileName);
        // Process template for creating source file
        else if (!processTemplate(tmpl, fileName, values_map))
          emitError(diag_engine,
                    dummy,
                    ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_GENERATION,
                    &fileName);
      }
      
      /**
       * ExecSQLLOBOpenToFunctionCall::doRequestHeaderGeneration
       *
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::doRequestHeaderGeneration(DiagnosticsEngine& diag_engine,
                                                                const std::string& tmpl,
                                                                string2_map& values_map)
      { 
        SourceLocation dummy;
	  ...
	  emitError(diag_engine,
		    dummy,
		    ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_EXISTS,
		    &fileName);
        // Process template for creating header file
        else if (!processTemplate(tmpl, fileName, values_map))
          emitError(diag_engine,
                    dummy,
                    ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_GENERATION,
                    &fileName);
      }
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::emitError(DiagnosticsEngine &diag_engine,
                                                const SourceLocation& err_loc,
                                                enum ExecSQLLOBOpenToFunctionCallErrorKind kind,
	...
	unsigned diag_id;
	    ...
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_NO_ERROR:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_ACCESS_CHAR_DATA:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_CANT_FIND_COMMENT_START:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_COMMENT_DONT_MATCH:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Warning,
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_GENERATION:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_GENERATION:
	    diag_id = TidyContext->getASTContext()->getDiagnostics().
	      getCustomDiagID(DiagnosticsEngine::Error,
          ...
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_SOURCE_EXISTS:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Error,
            ...
            /** Cannot generate request header file (no location) */
          case ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_HEADER_EXISTS:
            diag_id = TidyContext->getASTContext()->getDiagnostics().
              getCustomDiagID(DiagnosticsEngine::Error,
       ...
       */
      void
      ExecSQLLOBOpenToFunctionCall::check(const MatchFinder::MatchResult &result) 
      {
        ...
        if (lineNum > 0 && !errOccured)
          {
             ...
             * =============================================================================
             */
            if (lobOpenReqRe.match(comment, &matches))
              {
                std::string reqAllocName = matches[3];
                std::string reqReadOnly = matches[4];
                std::string requestExecSql = "LOB OPEN :";
                requestExecSql.append(reqAllocName);
		if (!reqReadOnly.empty())
		  requestExecSql.append(reqReadOnly.insert(0, " "));
                
                // Append first match (action) to function name
                function_name.append("lobOpen");
                ...
                if (generation_do_report_modification_in_pc)
                  {
                    ...
                    rv.insert(std::pair<std::string, std::string>("reqreadonly", reqReadOnly));
              ...
              emitError(diagEngine,
                        comment_loc_start,
                        ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_COMMENT_DONT_MATCH);
          }
        else
          {
            if (errOccured)
              ...
              emitError(diagEngine,
                        loc_start,
                        ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_ACCESS_CHAR_DATA);

            else
              // We didn't found the comment start ???
              emitError(diagEngine,
                        comment_loc_end,
                        ExecSQLLOBOpenToFunctionCall::EXEC_SQL_2_FUNC_ERROR_CANT_FIND_COMMENT_START);
          }
      }
    } // namespace pagesjaunes
  } // namespace tidy
